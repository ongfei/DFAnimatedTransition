//
//  DFTransitionManager+ViewMoveAnimation.m
...
@implementation DFTransitionManager (ViewMoveAnimation)

- (void)viewMoveRollNextWithType:(DFTransitionAnimationType )type andContext:(id<UIViewControllerContextTransitioning>)transitionContext {
...
- (void)viewMoveNextWithType:(DFTransitionAnimationType )type andContext:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    if (type == DFTransitionAnimationTypeViewMoveToNextVC) {

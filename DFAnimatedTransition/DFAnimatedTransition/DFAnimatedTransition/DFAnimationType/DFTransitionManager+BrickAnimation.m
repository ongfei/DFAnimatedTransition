//
//  DFTransitionManager+BrickAnimation.m
...
@implementation DFTransitionManager (BrickAnimation)
- (void)brickOpenNextWithType:(DFTransitionAnimationType)type andTransitionContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (type) {
        case DFTransitionAnimationTypeBrickOpenHorizontal:
...
- (void)brickCloseNextWithType:(DFTransitionAnimationType)type andTransitionContext:(id<UIViewControllerContextTransitioning>)transitionContext{
    ...
    switch (type) {
        case DFTransitionAnimationTypeBrickCloseHorizontal:
            rect0 = CGRectMake(0, 0 , screenWidth/2, screenHeight);
            rect1 = CGRectMake(screenWidth/2 , 0 , screenWidth/2, screenHeight);
            break;

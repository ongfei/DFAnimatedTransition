//
//  DFTransitionManager+SpreadAnimation.m
...
@implementation DFTransitionManager (SpreadAnimation)
- (void)spreadNextWithType:(DFTransitionAnimationType)type andTransitonContext:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    switch (type) {
        case DFTransitionAnimationTypeSpreadFromRight:
            rect0 = CGRectMake(screenWidth, 0, 2, screenHeight);
            break;
        case DFTransitionAnimationTypeSpreadFromLeft:
            rect0 = CGRectMake(0, 0, 2, screenHeight);
            break;
        case DFTransitionAnimationTypeSpreadFromTop:
